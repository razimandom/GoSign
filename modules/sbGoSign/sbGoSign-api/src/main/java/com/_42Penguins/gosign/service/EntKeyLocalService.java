...
/**
 * Provides the local service interface for EntKey. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Raziman Dom
 * @see EntKeyLocalServiceUtil
...
public interface EntKeyLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link EntKeyLocalServiceUtil} to access the ent key local service. Add custom service methods to {@link com._42Penguins.gosign.service.impl.EntKeyLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
