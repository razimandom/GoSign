...
import com._42Penguins.gosign.service.EntDocLocalService;
...
/**
 * Provides the base implementation for the ent doc local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com._42Penguins.gosign.service.impl.EntDocLocalServiceImpl}.
 * </p>
 *
 * @author Raziman Dom
 ...
 */
@ProviderType
public abstract class EntDocLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements EntDocLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com._42Penguins.gosign.service.EntDocLocalServiceUtil} to access the ent doc local service.
	 */
	...
	public EntDoc addEntDoc(EntDoc entDoc) {
		...
		return entDocPersistence.update(entDoc);
	}
	...
	public EntDoc createEntDoc(long docId) {
		return entDocPersistence.create(docId);
	}
	...
	public EntDoc deleteEntDoc(long docId) throws PortalException {
		return entDocPersistence.remove(docId);
	}
	...
	public EntDoc deleteEntDoc(EntDoc entDoc) {
		return entDocPersistence.remove(entDoc);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(EntDoc.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return entDocPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return entDocPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return entDocPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return entDocPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public EntDoc fetchEntDoc(long docId) {
		return entDocPersistence.fetchByPrimaryKey(docId);
	}
	...
	public EntDoc getEntDoc(long docId) throws PortalException {
		return entDocPersistence.findByPrimaryKey(docId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(entDocLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(EntDoc.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(entDocLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(EntDoc.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return entDocLocalService.deleteEntDoc((EntDoc)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return entDocPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<EntDoc> getEntDocs(int start, int end) {
		return entDocPersistence.findAll(start, end);
	}
	...
	public int getEntDocsCount() {
		return entDocPersistence.countAll();
	}
	 ...
	 */
	public EntDocLocalService getEntDocLocalService() {
	 ...
	 */
	public void setEntDocLocalService(EntDocLocalService entDocLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com._42Penguins.gosign.model.EntDoc",
			entDocLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com._42Penguins.gosign.model.EntDoc");
	}
	...
	public String getOSGiServiceIdentifier() {
		return EntDocLocalService.class.getName();
	}
	...
	@BeanReference(type = EntDocLocalService.class)
	protected EntDocLocalService entDocLocalService;
