...
/**
 * Provides the local service interface for GenKey. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see GenKeyLocalServiceUtil
...
public interface GenKeyLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link GenKeyLocalServiceUtil} to access the gen key local service. Add custom service methods to {@link DocRegistration.service.impl.GenKeyLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
